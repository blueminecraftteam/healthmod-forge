...
public class BlockRegistries {
    ...
    public static final RegistryObject<Block> BAND_AID_BOX = BLOCKS.register("band_aid_box", () -> new BandAidBoxBlock(AbstractBlock.Properties.create(Material.IRON).sound(SoundType.CLOTH)));
}
